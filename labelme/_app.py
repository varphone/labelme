...
""",
    ...
    def _setup_dock_widgets(self) -> _DockWidgets:
        ...
        file_list.currentItemChanged.connect(self._file_list_current_item_changed)
    ...
    def _file_list_current_item_changed(
        self,
        ...
        if not self._can_continue():
            return
        self._load_file(image_or_label_path=current.text())
